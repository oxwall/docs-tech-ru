...
Ключ разработчика в купе с ключом плагина или темы идентифицирует ваш плагин среди многих им подобных, а также они используется во всей внутренней экосистеме `Oxwall <http://oxwall.org>`_.

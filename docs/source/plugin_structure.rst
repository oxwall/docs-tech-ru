...
| - - *plugin.xml*
|
**Расмотрим все директории плагина:**
...
#. **update** - содержит файлы обновлений плагина. Подробнее с процессом обновления плагина можно познакомиться в разделе - :ref:`plugin_update-label`.
